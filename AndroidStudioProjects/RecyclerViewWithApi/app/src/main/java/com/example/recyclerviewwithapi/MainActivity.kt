...
import com.example.recyclerviewwithapi.databinding.ActivityMainBinding
import com.example.recyclerviewwithapi.viewModel.MainViewModel
        ...
        with(binding){
            ...
            myViewModel.datos.observe(this@MainActivity){
                if (it.status=="success"){
                    ...
                    Toast.makeText(applicationContext, "No hay fotos en esa raza", Toast.LENGTH_SHORT).show()
                }
            }
        }
